export const collections = [
    {
        ...
        description: "Nine gentle story cards inviting children to wonder, discover and explore the universe.",
        ...
        cards: [
            {
                ...
                storyTime: "Our Solar System is a busy neighborhood in space. At its center is the Sun, a star that gives light and warmth. Eight planets travel around it, along with moons, dwarf planets, asteroids and comets. Some worlds are rocky, others are enormous and cloudy, but they all belong to the same Solar System.",
                wonderQuestions: [
    ...
    },
    {
        ...
        description: "Nine gentle story cards inviting children to wonder, discover and explore autumn animals.",
        ...
        cards: [
            {
                ...
                storyTime: "Golden leaves cover the forest floor as the brown bear searches for berries and roots. Autumn is the season for eating and preparing. The bear knows the long winter sleep is coming soon. Every mouthful helps build strength for the cold months ahead while the forest slowly grows quieter each day.",
                wonderQuestions: [
